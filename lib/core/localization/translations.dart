const Map<String, Map<String, String>> translations = {
  'en': {
    ...
    'ai_analysis_title': 'AI Engineering Analysis',
    'ai_analyze_button': 'AI Analyze',
    'ai_generating': 'Generating engineering analysis with Groq...',
    'ai_paste_to_notes': 'Paste into Notes',
    'ai_append_to_notes': 'Append to Notes',
    'ai_copied_clipboard': 'Analysis copied to clipboard',
    'ai_notes_updated': 'AI analysis applied to Notes and saved.',
    'ai_groq_key_missing_title': 'Groq API Key Required',
    'ai_groq_key_missing_desc':
        'To use AI analysis, please configure GROQ_API_KEY in your .env file or enter a key below for this device.',
    'ai_save_key': 'Save API Key',
    'ai_clear_key': 'Clear Custom Key',
    'ai_key_saved': 'API key saved successfully.',
    'ai_enter_groq_key': 'Enter Groq API Key (gsk_...)',
  ...
  'nl': {
    ...
    'ai_analysis_title': 'AI Technische Analyse',
    'ai_analyze_button': 'AI Analyseren',
    'ai_generating': 'Technische analyse genereren met Groq...',
    ...
    'ai_notes_updated': 'AI-analyse toegepast op notities en opgeslagen.',
    'ai_groq_key_missing_title': 'Groq API-sleutel vereist',
    'ai_groq_key_missing_desc':
        'Configureer GROQ_API_KEY in uw .env-bestand of voer hieronder een sleutel in voor dit apparaat.',
    'ai_save_key': 'API-sleutel opslaan',
    'ai_clear_key': 'Aangepaste sleutel wissen',
    'ai_key_saved': 'API-sleutel succesvol opgeslagen.',
    'ai_enter_groq_key': 'Voer Groq API-sleutel in (gsk_...)',
    'ai_analysis_disclaimer':
  ...
  'de': {
    ...
    'ai_analysis_title': 'KI Technische Analyse',
    'ai_analyze_button': 'KI Analysieren',
    'ai_generating': 'Erstelle technische Analyse mit Groq...',
    ...
    'ai_notes_updated': 'KI-Analyse in Notizen übernommen und gespeichert.',
    'ai_groq_key_missing_title': 'Groq API-Schlüssel erforderlich',
    'ai_groq_key_missing_desc':
        'Konfigurieren Sie GROQ_API_KEY in Ihrer .env-Datei oder geben Sie unten einen Schlüssel für dieses Gerät ein.',
    'ai_save_key': 'API-Schlüssel speichern',
    'ai_clear_key': 'Benutzerdefinierten Schlüssel löschen',
    'ai_key_saved': 'API-Schlüssel erfolgreich gespeichert.',
    'ai_enter_groq_key': 'Groq API-Schlüssel eingeben (gsk_...)',
    'ai_analysis_disclaimer':
